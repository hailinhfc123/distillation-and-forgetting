...
class SumEvaluator:
    ...
    def evaluate(self, data, batch_size=8, device="cuda:0", dims=None, overall=True, print_result=False):
        """
        ...
        for dim in eval_dims:
            ...
            if dim == 'consistency' or dim == 'fluency':
                ...
                sent_score = self.scorer.score(input_list, batch_size=batch_size)
            ...
            # Calculate summary-level score for 'coherence' and 'relevance'
                ...
                score = self.scorer.score(input_list, batch_size=batch_size)
